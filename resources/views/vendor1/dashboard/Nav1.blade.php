        ...
        <div class="side-navbar-wrapper">
            ...
            <div class="main-menu">
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled active">
                    ...
                    <li><a href="/vendors" class="scroll"> <i class="icon-home"></i>Interested Farmers                             </a></li>
                    {{-- <li id=pk class="@if(Route::is('profile'))  active @endif"><a href="#" class="scroll"> <i class="icon-form"></i>Profile                            </a></li> --}}

                    <li><a href="/vendors/products"  data-target="#myModal"> <i class="fa fa-angellist"></i>Add Products                          </a></li>
